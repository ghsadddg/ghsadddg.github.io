...
document.getElementById('wssip').value='wss://gtasr.gangtongdata.com';
addresschange();
function addresschange()
{   
	
    var Uri = document.getElementById('wssip').value;
    // var Uri = 'ws://124.131.9.195:18333';  
...
function getJsonMessage( jsonMsg ) {
	...
	console.log(clickStartCon + rec_text);
	tinymce.get('varArea').setContent(clickStartCon + rec_text+'</p>');
...
function start() {
	...
	dialogCon = document.getElementById('dialog-con');
 	// console.log("isfilemode"+isfilemode);
 	// 清空当前文本
 	rec_text = '';
 	//清空历史文本
	offline_text="";
    clickStartCon = tinymce.get('varArea').getContent().slice(0,-4);
    // console.log(clickStartCon);
	//启动连接
